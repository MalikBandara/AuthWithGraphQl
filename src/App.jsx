              ...
              <div className="flex items-start justify-between mb-3">
                ...
                {user?.username === post.owner && (
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-emerald-400 to-cyan-400 text-white rounded-full text-sm font-medium hover:from-emerald-500 hover:to-cyan-500 transform hover:scale-105 transition-all duration-200 shadow-md opacity-0 group-hover:opacity-100"
                  >
                    Edit
                  </button>
                )}
